...
namespace SplashKitSDK
{
  public static class SplashKit
  {
    ...
    [DllImport("splashkit.dll", CallingConvention=CallingConvention.Cdecl, EntryPoint="__sklib__center_camera_on__sprite__float__float", CharSet=CharSet.Ansi)]
    private static extern void __sklib__center_camera_on__sprite__float__float(__sklib_ptr s, float offsetX, float offsetY);
    ...
    [DllImport("splashkit.dll", CallingConvention=CallingConvention.Cdecl, EntryPoint="__sklib__move_camera_by__float__float", CharSet=CharSet.Ansi)]
    private static extern void __sklib__move_camera_by__float__float(float dx, float dy);
    ...
    [DllImport("splashkit.dll", CallingConvention=CallingConvention.Cdecl, EntryPoint="__sklib__to_screen_x__float", CharSet=CharSet.Ansi)]
    private static extern float __sklib__to_screen_x__float(float worldX);

    [DllImport("splashkit.dll", CallingConvention=CallingConvention.Cdecl, EntryPoint="__sklib__to_screen_y__float", CharSet=CharSet.Ansi)]
    private static extern float __sklib__to_screen_y__float(float worldY);
    ...
    [DllImport("splashkit.dll", CallingConvention=CallingConvention.Cdecl, EntryPoint="__sklib__to_world_x__float", CharSet=CharSet.Ansi)]
    private static extern float __sklib__to_world_x__float(float screenX);

    [DllImport("splashkit.dll", CallingConvention=CallingConvention.Cdecl, EntryPoint="__sklib__to_world_y__float", CharSet=CharSet.Ansi)]
    private static extern float __sklib__to_world_y__float(float screenY);
    ...
    public static void CenterCameraOn(Sprite s, float offsetX, float offsetY)
    {
      __sklib_ptr __skparam__s;
      float __skparam__offset_x;
      float __skparam__offset_y;
      __skparam__s = __skadapter__to_sklib_sprite(s);
    ...
    public static void MoveCameraBy(float dx, float dy)
    {
      float __skparam__dx;
      float __skparam__dy;
